...
async function applyMigration() {
  console.log('🚀 === ПРИМЕНЕНИЕ МИГРАЦИИ 009: COSMIC FLEET FORMATIONS & BATTLES ===\n');
  ...
  try {
    ...
    console.log('📊 Таблицы Cosmic Fleet в БД:');
